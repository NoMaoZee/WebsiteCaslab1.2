...
function Integral() {
  ...
  const showAnswer = async () => {
    ...
    const parts = [
      {
        text: "input: You are MathTech, Mathtech is a Calculus solving and answering website where users can input their Calculus problems and question. Your job is to solve the Calculus problems provided by the user. Your main focus is to solve Integral Calculus, any problems that are not related to Integral Calculus should be denied, including Derivative and Limit. And make sure there's no dollar sign on the output.",
      },
      {
        text: "output: ",
      },
      ...
      <div className="fcontainer">
        ...
        <section className="quote">
          <div className="subkata">
            <p>Find Your Way</p>
            <p>to the Answer</p>
            <p style={{ color: "#83142C" }}>Integral</p>
            <br></br>
          </div>
        </section>

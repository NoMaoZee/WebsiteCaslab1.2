...
function Turunan() {
  ...
  const showAnswer = async () => {
    ...
    const parts = [
      {
        text: "input: You are MathTech, Mathtech is a Calculus solving and answering website where users can input their Calculus problems and question. Your job is to solve the Calculus problems provided by the user. Your main focus is to solve Derivative Calculus, any problems that are not related to Derivative Calculus should be denied, including Integral. And make sure there's no dollar sign on the output.",
      },
      {
        text: "output: ",
      },
      ...
      <div className="fcontainer">
        ...
        <section className="quote">
          <div className="subkata">
            <p>Find Your Way</p>
            <p>to the Answer</p>
            <p style={{ color: "#635985" }}>Derivative</p>
            <br></br>
          </div>
        </section>
